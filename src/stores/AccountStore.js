...
class AccountStore {
  ...
  onConnected () {
    ...
    _connectionTimer = setInterval(function(){
        self.setState({connectionTime: self.connectionTime+1});
    }, 1000);
  }
  ...
  onDisconnected () {
    this.setState({connected: false, connecting: false, connectionTime: 0});
  }
